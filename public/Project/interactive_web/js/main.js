(() => {
	...
	const sceneInfo = [
		{
			...
			scrollHeight: 0,
			objs: {
				header: document.querySelector('#scroll-section-0 .local-nav'),
			...
			values: {
				...
				messageA_translateY_in: [10, 0, { start: 0.1, end: 0.2 }],
				messageB_translateY_in: [10, 0, { start: 0.3, end: 0.4 }],
				messageC_translateY_in: [10, 0, { start: 0.5, end: 0.6 }],
				messageD_translateY_in: [10, 0, { start: 0.7, end: 0.8 }],
		...
		},
		{
			...
			values: {
				...
				canvas_opacity_out: [1, 0, { start: 0.95, end: 1 }],
				messageA_translateY_in: [10, 0, { start: 0.15, end: 0.2 }],
		...
		},
		{
			...
			objs: {
				...
				imagesPath: [
					'./images/blend-img1.jpg',
					'./images/blend-img2.jpg'
				],
				images: []
			},
			values: {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `./video/001/IMG_${181 + i}.jpg`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `./video/002/IMG_${6999 + i}.JPG`;
	...
	function playAnimation() {
		...
		const scrollHeight = sceneInfo[currentScene].scrollHeight;
		const scrollRatio = currentYOffset / scrollHeight;
		const header =  document.querySelector('.local-nav a');
		switch (currentScene) {
			case 0:
				// console.log('0 play');
